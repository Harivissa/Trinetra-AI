...
export const COUNTRY_LEADERSHIP_REGISTRY: Record<string, CountryLeadershipDossier> = {
  ...
  USA: {
    ...
    governingParty: "Republican Administration",
    ...
    leaders: [
      {
        ...
        sourceName: "The White House Historical Association / Official Registry",
        since: "Since Jan 2025",
        termInfo: "47th President (Head of State & Government)",
        verifiedAt: "2026-09-15",
        countryCode: "USA",
      },
    ],
